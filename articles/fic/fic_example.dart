...
void main() {
  //----------------------------------------------------------------------------
  // 1. Classes with Regular, Mutable Collections

  print("1. With Regular Collections\n\n");
  ...
  //----------------------------------------------------------------------------
  // 2. Classes with FIC, i.e., immutable collections
  ...
  print(peopleWithFic2.hashCode ==
      PeopleWithFic([bob, jake].lock).hashCode); // true
  //----------------------------------------------------------------------------
}
//------------------------------------------------------------------------------
...
class People {
  ...
  bool _listEquals<T>(List<T> a, List<T> b) {
    ...
    // For more info on this, search for Tail Call Optimization (TCO).
